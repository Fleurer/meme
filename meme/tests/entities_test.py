...
class TestExchange(unittest.TestCase):
    ...
    def test_enqueue_and_dequeue1(self):
        ...
        self.assertEqual(list(self.exchange.asks.keys()), [Decimal('0.1')])
        self.assertEqual(list(self.exchange.asks.values()), [deque([1, 2])])
        self.exchange.dequeue(ask0)
        self.assertEqual(list(self.exchange.asks.keys()), [Decimal('0.1')])
        self.assertEqual(list(self.exchange.asks.values()), [deque([2])])
        self.exchange.dequeue(ask1)
        self.assertEqual(list(self.exchange.asks.keys()), [])
    ...
    def test_enqueue_and_dequeue2(self):
        ...
        self.assertEqual(list(self.exchange.bids.values()), [deque([1, 2])])
        self.exchange.dequeue(bid0)
        self.assertEqual(map(float, self.exchange.bids.keys()), [0.1])
        self.assertEqual(list(self.exchange.bids.values()), [deque([2])])
        self.exchange.dequeue(bid1)
        self.assertEqual(list(self.exchange.bids.keys()), [])
